...
Public Class LapAbsensi_Siswa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.LapAbsensi_Siswa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapAbsensi_Siswa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapAbsensi_Siswa = New LapAbsensi_Siswa()
        rpt.Site = Me.Site
        Return rpt
    End Function
