...
Public Class LapPersetujuan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.LapPersetujuan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ID_PEGAWAI() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedLapPersetujuan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapPersetujuan = New LapPersetujuan()
        rpt.Site = Me.Site
        Return rpt
    End Function
