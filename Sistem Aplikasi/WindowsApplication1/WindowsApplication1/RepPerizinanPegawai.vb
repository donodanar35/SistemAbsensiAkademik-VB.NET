...
Public Class RepPerizinanPegawai
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RepPerizinanPegawai.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.RepPerizinanPegawai.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepPerizinanPegawai
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepPerizinanPegawai = New RepPerizinanPegawai()
        rpt.Site = Me.Site
        Return rpt
    End Function
